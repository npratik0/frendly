...
//       },
//       (posts) {
//         state = state.copyWith(isLoadingSaved: false, savedPosts: posts);
//       },
//     );
//   }
...
//     final isFollowing = state.profile!.isFollowing(_currentUserId ?? '');
...
// // Family provider for different users
...
// FIXED VERSION - Corrected family provider and JSON parsing
...
// ❌ REMOVE the family provider - not needed for simple use case
// If you need multiple profile instances, use the single provider and pass userId to methods
