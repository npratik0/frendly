...
//   // Tilt parameters
//   static const double tiltThreshold = 2.0; // Minimum tilt to trigger scroll
...
//     final double speed = (tiltY.abs() / 10.0 * maxScrollSpeed).clamp(
//       1.0,
//       maxScrollSpeed,
//     );
...
// lib/core/services/tilt_scroll_service.dart
// UPDATED VERSION - Higher threshold for better control
